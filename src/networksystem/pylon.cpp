...
ConVar pylon_host_ip_override("pylon_host_ip_override", "", FCVAR_RELEASE | FCVAR_ACCESSIBLE_FROM_THREADS, "Override the public IP address sent to the Pylon master server");
ConVar pylon_host_port_override("pylon_host_port_override", "0", FCVAR_RELEASE | FCVAR_ACCESSIBLE_FROM_THREADS, "Override the public port sent to the Pylon master server");
